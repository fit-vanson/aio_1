    ...
    <div class="modal-dialog modal-xl" id="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="devhuaweiForm" name="devhuaweiForm" class="form-horizontal">
                    ...
                    <div data-repeater-list="group-a">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="inner row">
                                    <div class="col-md-12 col-12">
                                        <select class="form-control select2js" id="huawei_ga_name" name="huawei_ga_name">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="inner row">
                                    <div class="col-md-10 col-10">
                                        <select class="form-control select2js" id="huawei_email" name="huawei_email">
                                            <option value="0">---Vui lòng chọn---</option>
                        ...
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" id="huawei_dev_name" name="huawei_dev_name" class="form-control" required>
                            </div>
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input id="huawei_company" name="huawei_company" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <textarea id="huawei_add" name="huawei_add" class="form-control" rows="4" ></textarea>
                            </div>
                            <div class="form-group col-lg-6 ">
                                <label for="name">Ghi chú</label>
                                <textarea id="huawei_note" name="huawei_note" class="form-control" rows="4" ></textarea>
                            </div>
                        </div>
                    </div>
