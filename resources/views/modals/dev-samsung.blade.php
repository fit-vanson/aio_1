    ...
    <div class="modal-dialog modal-xl" id="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="devSamsungForm" name="devSamsungForm" class="form-horizontal">
                    ...
                    <div data-repeater-list="group-a">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="inner row">
                                    <div class="col-md-12 col-12">
                                        <select class="form-control select2js" id="samsung_ga_name" name="samsung_ga_name">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="inner row">
                                    <div class="col-md-10 col-10">
                                        <select class="form-control select2js" id="samsung_email" name="samsung_email">
                                            <option value="0">---Vui lòng chọn---</option>
                        ...
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" id="samsung_dev_name" name="samsung_dev_name" class="form-control" required>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="name">Store Name  <span style="color: red">*</span></label>
                                <input type="text" id="samsung_store_name" name="samsung_store_name" class="form-control" required>
                            </div>
                        </div>
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
