    ...
    <div class="modal-dialog modal-xl" id="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="devXiaomiForm" name="devXiaomiForm" class="form-horizontal">
                    ...
                    <div data-repeater-list="group-a">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="inner row">
                                    <div class="col-md-12 col-12">
                                        <select class="form-control select2js" id="xiaomi_ga_name" name="xiaomi_ga_name">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="inner row">
                                    <div class="col-md-10 col-10">
                                        <select class="form-control select2js" id="xiaomi_email" name="xiaomi_email">
                                            <option value="0">---Vui lòng chọn---</option>
                        ...
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" id="xiaomi_dev_name" name="xiaomi_dev_name" class="form-control" required>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="name">Store Name  <span style="color: red">*</span></label>
                                <input type="text" id="xiaomi_store_name" name="xiaomi_store_name" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" id="xiaomi_phone" name="xiaomi_phone" class="form-control" >
                            </div>
                            <div class="form-group col-lg-6 ">
                                <label for="name">Mật khẩu</label>
                                <input type="text" id="xiaomi_pass" name="xiaomi_pass" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input id="xiaomi_company" name="xiaomi_company" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <textarea id="xiaomi_add" name="xiaomi_add" class="form-control" rows="4" ></textarea>
                            </div>
                            <div class="form-group col-lg-6 ">
