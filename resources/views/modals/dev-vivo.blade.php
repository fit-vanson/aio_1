                    ...
                    <div data-repeater-list="group-a">
                        ...
                        <div data-repeater-item="" class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                {{--                                <input type="text" id="vivo_profile_info" name="vivo_profile_info" class="form-control" >--}}
                                <select class="form-control select2js" id="vivo_profile_info" name="vivo_profile_info">
                                    <option value="0">---Vui lòng chọn---</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input id="vivo_company" name="vivo_company" class="form-control" />
                            </div>
                        </div>
                        <div data-repeater-item="" class="row">
                            <div class="form-group col-lg-6">
                                <label for="name">Địa chỉ </label>
                                <textarea id="vivo_add" name="vivo_add" class="form-control" rows="4" ></textarea>
                            </div>
                            <div class="form-group col-lg-6 ">
