...
@section('breadcrumb')
<div class="col-sm-6">
    <h4 class="page-title">Market Samsung</h4>
</div>
...
<script type="text/javascript">
    ...
    function detailSamsung(id) {
        $.get('{{asset('project/edit')}}/'+id,function (data) {
            ...
            $('#package').val(data[0].Samsung_package);
            $('#buildinfo_store_name_x').val(data[2].store_name);
            $('#ads_id').val(Samsung_ads.ads_id);
            $('#banner').val(Samsung_ads.ads_banner);
            $('#ads_inter').val(Samsung_ads.ads_inter);
            $('#ads_reward').val(Samsung_ads.ads_reward);
            $('#ads_native').val(Samsung_ads.ads_native);
            $('#ads_open').val(Samsung_ads.ads_open);
